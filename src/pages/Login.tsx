...
=======
    ...
    signOut,
    getIdToken,
>>>>>>> 193fed813e2c441870c4f9b39442f15992f87f23
} from "firebase/auth";
...
=======
    ...
    const loginWithProvider = async (provider: typeof google | typeof facebook) => {
        try {
...
=======
        <div
            className="min-h-screen min-w-screen grid place-items-center bg-[url('/img/imgLogin/BGLogin.svg')] bg-cover"
            id="Login"
        >
            <div className="z-10 absolute min-w-screen min-h-screen opacity-30 bg-[url('/img/imgLogin/LerneyJourneyBgStar.gif')]" />
                ...
                <div className="space-y-2 mb-2">
                    ...
                    >
                        <div className="flex w-full text-center content-center justify-items-center justify-center items-center">
                            <div className="flex-none w-10">
                                <img
                                    src="/img/Logo/FaceBook_Icon.svg"
                                    alt=""
                                    className="w-8 mr-4"
                                />
                            </div>
